...
var file_pb_proto_rawDesc = []byte{
	0x0a, 0x08, 0x70, 0x62, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x70, 0x62, 0x22, 0x28,
	...
	0x12, 0x2b, 0x0a, 0x05, 0x55, 0x6e, 0x61, 0x72, 0x79, 0x12, 0x10, 0x2e, 0x70, 0x62, 0x2e, 0x48,
...
var file_pb_proto_depIdxs = []int32{
	0, // 0: pb.HelloService.Unary:input_type -> pb.HelloRequest
	1, // 1: pb.HelloService.Unary:output_type -> pb.HelloReply
...
func (c *helloServiceClient) Unary(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/pb.HelloService/Unary", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HelloService_Unary_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.HelloService/Unary",
	}
