...
var file_options_proto_extTypes = []protoimpl.ExtensionInfo{
	...
	},
	{
		...
		ExtensionType: (*bool)(nil),
		Field:         74613,
		Name:          "vv.options.duration",
		Tag:           "varint,74613,opt,name=duration",
		Filename:      "options.proto",
	},
}
...
var (
	...
	// optional bool duration = 74613;
	E_Duration = &file_options_proto_extTypes[21] // 7s
)
...
var file_options_proto_rawDesc = []byte{
	...
	0x63, 0x73, 0x74, 0x44, 0x61, 0x79, 0x88, 0x01, 0x01, 0x3a, 0x3e, 0x0a, 0x08, 0x64, 0x75, 0x72,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1d, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x4f, 0x70, 0x74,
	0x69, 0x6f, 0x6e, 0x73, 0x18, 0xf5, 0xc6, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x64, 0x75,
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x88, 0x01, 0x01, 0x42, 0x24, 0x5a, 0x22, 0x67, 0x69, 0x74,
...
var file_options_proto_depIdxs = []int32{
	...
	3,  // 21: vv.options.duration:extendee -> google.protobuf.FieldOptions
	0,  // 22: vv.options.method_authorization:type_name -> vv.options.Handler
	0,  // 23: vv.options.method_proxy_authorization:type_name -> vv.options.Handler
	0,  // 24: vv.options.method_whitelisting:type_name -> vv.options.Handler
	0,  // 25: vv.options.authorization:type_name -> vv.options.Handler
	0,  // 26: vv.options.proxy_authorization:type_name -> vv.options.Handler
	0,  // 27: vv.options.whitelisting:type_name -> vv.options.Handler
